...
admin.site.site_header = "MALI"
admin.site.site_title = "MALI Admin Portal"
admin.site.index_title = "MALI Admin"

# swagger
api_info = openapi.Info(
    title="MALI API",
    default_version="v1",
    description="API documentation for MALI App",
)
